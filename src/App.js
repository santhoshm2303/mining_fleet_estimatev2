...
const PHYS_FIELDS = [
  ...
  {key:"totalMined",label:"Total Mined",unit:"t"},
  {key:"totalRampMined",label:"Ramp Tonnes",unit:"t"},
  {key:"avgLoadedTravelTime",label:"Loaded Travel",unit:"min"},
  {key:"avgUnloadedTravelTime",label:"Unloaded Travel",unit:"min"},
  {key:"avgTkphDelay",label:"TKPH Delay",unit:"min"},
  {key:"avgNetPower",label:"Net Power",unit:"kWh"},
  {key:"oreFePct",label:"Ore Fe %",unit:"%"},
  {key:"oreSiPct",label:"Ore Si %",unit:"%"},
  {key:"oreAlPct",label:"Ore Al %",unit:"%"},
  {key:"orePPct",label:"Ore P %",unit:"%"}
];
